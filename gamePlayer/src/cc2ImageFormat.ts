import { TerseCC2FrameMap } from "./visuals"

const cc2ImageFormat: TerseCC2FrameMap = {
	placeholder: [0, 0],
	chip: {
		up: [
			[0, 22],
	...
	notGate: { 0: [0, 25], 1: [1, 25], 2: [2, 25], 3: [3, 25] },
	andGate: { 0: [4, 25], 1: [5, 25], 2: [6, 25], 3: [7, 25] },
	orGate: { 0: [8, 25], 1: [9, 25], 2: [10, 25], 3: [11, 25] },
	xorGate: { 0: [12, 25], 1: [13, 25], 2: [14, 25], 3: [15, 25] },
	latchGate: { 0: [0, 26], 1: [1, 26], 2: [2, 26], 3: [3, 26] },
	latchGateMirror: { 0: [8, 21], 1: [9, 21], 2: [10, 21], 3: [11, 21] },
	nandGate: { 0: [4, 26], 1: [5, 26], 2: [6, 26], 3: [7, 26] },
	counterGate: [14, 26],
}
